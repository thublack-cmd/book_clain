...
from app.models import db, Clain_tri
...
def client_view():
    if request.method == 'POST':
        ...
        return redirect(url_for('tribeca.client_view'))
...
@tribeca.route('/', methods=['POST', 'GET'])
@login_required
def audit_view():
